...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add ServiceWorkOrdersPlugin.csproj package Microting.eForm
	dotnet add ServiceWorkOrdersPlugin.csproj package Microting.eFormApi.BasePn
	dotnet add ServiceWorkOrdersPlugin.csproj package Microting.WorkOrderBase
